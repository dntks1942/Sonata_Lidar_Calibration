		...
		ros::NodeHandle private_nh)
{
	...
	config_.npackets = (int) ceil(packet_rate / frequency); //# Original 20190731
	//it is changed to 1, (modified)Expects to publish data right after it gets one data packet from device, 20190731
