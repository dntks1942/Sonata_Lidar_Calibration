...
#include <velodyne_driver/time_conversion.hpp> // added for gps time syncronization. 20190709 hw 
			...
			port_(port)
{
	...
	private_nh.param("gps_time", gps_time_, false); // added for gps time syncronization. 20190709 hw
	if (!devip_str_.empty())
...
int InputSocket::getPacket(velodyne_msgs::VelodynePacket *pkt, const double time_offset)
{
	...
	// commented and added for gps time syncronization. 20190709 hw
	/*
